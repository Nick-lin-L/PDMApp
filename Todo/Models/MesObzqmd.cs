...
{
    public partial class MesObzqmd
    {
        public string Zqmdname { get; set; }
        public string Facility { get; set; }
        public string Werks { get; set; }
        public string Producttype { get; set; }
        public string Foqcno { get; set; }
        public string Step { get; set; }
        public string Sublineno { get; set; }
        public string Shiftdefinitionshift { get; set; }
        ...
        public string Mescomponent { get; set; }
        public string Componentdesczf { get; set; }
        public string Componentdescen { get; set; }
        public decimal? Leftqty { get; set; }
        public decimal? Rightqty { get; set; }
        public string Defectkind { get; set; }
        public string Defectkinddesczf { get; set; }
        public string Defectkinddesclocal { get; set; }
        public string Defectcode { get; set; }
        public string Defectdesczf { get; set; }
        public string Defectdesclocal { get; set; }
        public string Productdate { get; set; }
        public string Zzbatchid { get; set; }
        public string Orderlevel { get; set; }
        public string Qclevel { get; set; }
        public decimal? Qcqty { get; set; }
        public decimal? Defectqty { get; set; }
        public string Memo { get; set; }
        public char? Zzactresult { get; set; }
        public string Sapdefecttype { get; set; }
        public string Approvetime { get; set; }
        public char? Isdelete { get; set; }
        public string Resourcegroup { get; set; }
        public string Mesresource { get; set; }
        ...
        public string Timmeron { get; set; }
        public char? Processmk { get; set; }
        public char? WebProcessmk { get; set; }
        public string Datagroup { get; set; }
        public string ReceiveTime { get; set; }
        public string KbnProcessmk { get; set; }
    }
}
