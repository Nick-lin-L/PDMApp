...
{
    public partial class plm_product_head
    {
        ...
        public string bt_project { get; set; }
        public string account_code { get; set; }
        public string account_name { get; set; }
        public string account_exclusivity { get; set; }
        public string region_exclusivity { get; set; }
        public string regional_approval { get; set; }
        public string regional_approval_date { get; set; }
        ...
        public string tdm_status { get; set; }
        public string sfm_date { get; set; }
        public string sfm_date_status { get; set; }
        ...
        public decimal? global_srp { get; set; }
        public string key_item { get; set; }
        public decimal? target_fob { get; set; }
        ...
        public string lp02_season_forecast { get; set; }
        public string lp03_season_forecast { get; set; }
        public string lp02_yearly_forecast { get; set; }
